...
\begin{exercise}{3.16}
Let $\mathscr{G}_1$ and $\mathscr{G}_2$ be two graphs over $\mathscr{X}$. Assume that $\mathscr{G}_1$ and $\mathscr{G}_2$ have the same skeleton and v-structures. Let $(X\perp Y\mid Z)$ be a conditional independency in $\mathscr{I}(\mathscr{G}_1).$ Thus, $X$ and $Y$ are d-seperated given $Z$ by Theorem 3.4. D-separation means there is not an active trail between $X$ and $Y$. This means that every v-structure passed through must have the center node or one of its descendants is in $Z$. Otherwise is does not pass through an observation. Since $\mathscr{G}_1$ and $\mathscr{G}_2$ have the same v-structures, a trail between $X$ and $Y$ on $\mathscr{G}_2$ with v-structures will also have the center node as an observation if it was the center node in the v-structure in $\mathscr{G}_1$. If one of its descendants was a observation in $\mathscr{G}_1$, it must also be a descendant of the center node in $\mathscr{G}_2$, since if it was not, it would create a new v-structure which is a contradiction. Further, since all skeletons are the same, the rest of the trail must not have any other observations in $\mathscr{G}_2$ since they were not in the trail in $\mathscr{G}_1$. Thus, the trail from $X$ to $Y$ in $\mathscr{G}_2$ is active. 
\end{exercise}
\end{document}