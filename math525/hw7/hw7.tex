...
\begin{align}
\mathbf{x}&\rightarrow\mathbf{1}+\frac{1}{\kappa_1}A\mathbf{1}+\frac{1}{\kappa_2^2}A^2\mathbf{1}+\dotsb
\end{align}
This implies that $\kappa_1\mathbf{x}\rightarrow \kappa_1\mathbf{1}+A\mathbf{1}+\frac{1}{\kappa_1}A^2\mathbf{1}+\dotsb$. Again, evaluating on the dominant terms gives that $\kappa_1\mathbf{x}\approx \kappa_1\mathbf{1}+A\mathbf{1}=(\kappa_1I+A)\mathbf{1}$.

This implies that $(I-\alpha A)\mathbf{x}=\mathbf{1}\rightarrow(I-\frac{1}{\kappa_1}A)\mathbf{x}=\mathbf{1}$.
\end{enumerate}
